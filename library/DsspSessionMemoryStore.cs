...
{
    public class DsspSessionMemoryStore : IDsspSessionStore
    {
        private static IDsspSessionStore instance;

        public static IDsspSessionStore Default
        {
            get
            {
                if (instance == null)
                    instance = new DsspSessionMemoryStore();
                return instance;
            }
        }
